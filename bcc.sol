...
contract BioticCommercialCoin is Context, IBEP20, Ownable {
  ...
  string public _name;
  uint256 public _burnAmt = 10e14;
  uint256 public _maxBurnAmt = 500000e18;
  uint256 public _totalBurned = 0;

  constructor() public {
    _name = "Biotic Commercial Coin";
    _symbol = "BCC";
    _decimals = 18;
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(_totalBurned<=_maxBurnAmt){
      _totalBurned = _totalBurned.add(_burnAmt);
